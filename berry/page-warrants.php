...
$header_text = get_field('header_text_warrants', 'option'); ?>
					...
					<?php endif; ?>
								...
								<div class="main-annual">
									...
									<div class="box-annual">
										<?php if( have_rows('warrants_head', 'option') ): ?>

												<?php while( have_rows('warrants_head', 'option') ): the_row();

													// vars 1
													$name = get_sub_field('year_warrants_name', 'option');
													?>
													<h3><?php echo $name; ?></h3>
													<?php if( have_rows('sub_warrants_year', 'option') ): ?>

															<?php while( have_rows('sub_warrants_year', 'option') ): the_row();

																// vars
																$sub_name = get_sub_field('name_file_warrants', 'option');
																$file = get_sub_field('file_warrants', 'option');
