<?php
/**
 * Template Name: Page ANNUAL REPORT
 *
...
$header_text = get_field('header_text_annual', 'option'); ?>
					...
					<?php endif; ?>
								...
								<div class="main-annual">
									...
									<div class="box-annual">
										<?php if( have_rows('annual_reporting_head', 'option') ): ?>

												<?php while( have_rows('annual_reporting_head', 'option') ): the_row();

													// vars 1
													$name = get_sub_field('year_annual_reporting_name', 'option');
													?>
													<h3><?php echo $name; ?></h3>
													<?php if( have_rows('sub_annual_reporting_year', 'option') ): ?>

															<?php while( have_rows('sub_annual_reporting_year', 'option') ): the_row();

																// vars
																$sub_name = get_sub_field('name_file_annual_reporting', 'option');
																$file = get_sub_field('file_annual_reporting', 'option');
