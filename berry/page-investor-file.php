<?php
/**
 * Template Name: Page Corporate Governance File
 *
				...
				<div id="col-main" class="col-md-12 main-primary">
					...
					<?php endif; ?>
							...
							<div class="detail-file">
								<?php if( have_rows('file_repeat', 'option') ): ?>
									<table>
										<thead>
											<tr>
											...
											<tbody>
									<?php while( have_rows('file_repeat', 'option') ): the_row();

										// vars
										$name = get_sub_field('name_file', 'option');
