<?php
/**
 * Template Name: Page FINANCIAL STATEMENT
 *
...
$header_text = get_field('header_text_financial_statement', 'option'); ?>
					...
					<?php endif; ?>
								...
								<div class="main-annual">
									...
									<div class="box-annual">
										<?php if( have_rows('financial_statement_head', 'option') ): ?>

												<?php while( have_rows('financial_statement_head', 'option') ): the_row();

													// vars 1
													$name = get_sub_field('year_financial_statement_name', 'option');
													?>
													<h3><?php echo $name; ?></h3>
													<?php if( have_rows('sub_financial_statement_year', 'option') ): ?>

															<?php while( have_rows('sub_financial_statement_year', 'option') ): the_row();

																// vars
																$sub_name = get_sub_field('name_file_financial_statement', 'option');
																$file = get_sub_field('file_financial_statement', 'option');
